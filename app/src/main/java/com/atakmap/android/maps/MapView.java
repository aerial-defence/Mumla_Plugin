 ...
 * <p>
 * Responsible for dispatched {@link MapEvent}s:
 * <ul>
 * <li>{@link MapEvent#MAP_MOVED} when the position, zoom, or focus
 * changes</li>
 * <li></li>
 * </ul>
 * </p>
...
public class MapView extends AtakMapView {
    ...
    /**
     * Set arbitrary data from a {@link MapComponent}. This makes the
    ...
    /**
     * Get arbitrary data set by a {@link MapComponent}. This allows for
